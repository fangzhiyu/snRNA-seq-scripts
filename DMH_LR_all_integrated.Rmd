...
start_time = Sys.time()
DMH_ipsi = readRDS("D:/fzy/10x_DMH/0_qc/DMH_SNI_ipsi/DMH_SNI_ipsi.240115.rds")
DMH_contra = readRDS('D:/fzy/10x_DMH/0_qc/DMH_SNI_contra/DMH_SNI_contra.240115.rds')
DMH_Sham  = readRDS('D:/fzy/10x_DMH/0_qc/DMH_Sham/DMH_Sham.231207.rds')
DMH_Sham_1 = readRDS('D:/fzy/10x_DMH/0_qc/DMH_Sham_1/DMH_Sham_1.231207.rds')
DMH_Sham_2 = readRDS('D:/fzy/10x_DMH/0_qc/DMH_Sham_2/DMH_Sham_2.231207.rds')
DMH_SNI = readRDS('D:/fzy/10x_DMH/0_qc/DMH_SNI/DMH_SNI.231208.rds')
DMH_SNI_1 = readRDS('D:/fzy/10x_DMH/0_qc/DMH_SNI_1/DMH_SNI_1.231208.rds')
DMH_SNI_2 = readRDS('D:/fzy/10x_DMH/0_qc/DMH_SNI_2/DMH_SNI_2.231208.rds') # 不加入刺激的整合
seurat.objects = ls(pattern="^DMH_")
```

```{r merge}
DMH_all = Reduce(function(x,y) merge(x,y), lapply(seurat.objects,function(name) get(name)))
rm(list=grep("^DMH_(?!all).*",ls(),value=T,perl=T))
# plan("sequential")
# plan("multisession",workers=7)#别多核了 
